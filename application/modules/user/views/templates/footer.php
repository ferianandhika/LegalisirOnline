<footer class="footer footer-default">
  <div class="container">
    ...
    <div class="copyright float-right">
      ...
      <a href="https://www.creative-tim.com/" target="_blank">Ferian Andhika Toasi</a> for a better web.
    </div>
  </div>
</footer>
  <script>
...
<script src="<?php echo base_url() ?>assets/user/js/core/bootstrap-material-design.min.js" type="text/javascript">
</script>
<script src="<?php echo base_url() ?>assets/user/js/plugins/moment.min.js"></script>
<!--	Plugin for the Datepicker, full documentation here: https://github.com/Eonasdan/bootstrap-datetimepicker -->
<script src="<?php echo base_url() ?>assets/user/js/plugins/bootstrap-datetimepicker.js" type="text/javascript">
</script>
...
<script src="<?php echo base_url() ?>assets/user/js/coba.js" type="text/javascript"></script>
