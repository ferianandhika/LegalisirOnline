    ...
    <div class="left side-menu">
      <div class=" sidebar-inner slimscrollleft">
        ...
        <div class="user-box">
          <div class="user-img">
            <img src="<?= base_url('assets/img/profile/') . $userr['image'] ?>" alt="user-img" title="Mat Helme"
              class="rounded-circle img-thumbnail img-responsive">
            <div class="user-status offline"><i class="mdi mdi-adjust"></i></div>
          </div>
          <h5><a href="#"><?= $userr['name']; ?></a> </h5>
        ...
        <div id="sidebar-menu">
          <ul>
            ...
            <li>
              <a href="<?php echo base_url() ?>admin" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span>
                  Dashboard </span> </a>
            </li>

            <li>
              <a href="<?php echo base_url() ?>admin/user" class="waves-effect"><i class="mdi mdi-account"></i> <span>
                  User </span> </a>
            </li>
            ...
            <li>
              <a href="<?php echo base_url() ?>admin/informasi" class="waves-effect"><i class="mdi mdi-apps"></i> <span>
                  Informasi </span> </a>
            </li>
            <li>
              <a href="<?php echo base_url() ?>admin/setting" class="waves-effect"><i
                  class="mdi mdi-table-settings"></i>
                <span> Setting </span> </a>
            </li>
            <li class="has_sub">
              <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-user"></i><span>Akun </span> <span
                  class="menu-arrow"></span></a>
              <ul class="list-unstyled">
                <li><a href="<?php echo base_url() ?>admin/profil">Profil</a></li>
                <li><a href="<?php echo base_url() ?>admin/password">Ubah Password</a></li>
              </ul>
            </li>
