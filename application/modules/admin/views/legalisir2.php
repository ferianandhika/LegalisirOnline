            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box table-responsive">
                        <!-- filter laporan  -->
                        <form action="<?= base_url('admin/legalisir2/filter'); ?>" method="post">
                            <label for="">Filter Berdasarkan :</label><br>
                            ...
                            <button type="submit" class="btn btn-success btn-sm mb-2"><i class="mdi mdi-file-excel mr-1"></i>Export</button>
                        </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select class="form-control" name="status_<?php echo $row->id_legalisir;?>"
                                            ...
                                            <option value="2" <?= $row->status == 2 ? ' selected="selected"' : '';?>>
                                                Dikirim
                                            </option>
                                            <option value="3" <?= $row->status == 3 ? ' selected="selected"' : '';?>>
                                                Selesai
                                            </option>
                                        </select>
                                        <?php else : ?>
